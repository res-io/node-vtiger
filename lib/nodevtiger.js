...
(function () {
    ...
    NodeVtigerWS = (function () {
        ...
        NodeVtigerWS.prototype.doLogout = function (callback) {
            var params,
                _this = this;
            this.callback = callback;
            params = '?operation=logout&sessionName=' + this._wsSessionName;
            this.log.trace("Logout " + this._wsUrl + params);
            request.post(this._wsUrl + params, function (e, r, body) {
